...
<div class="box-body">
<p><b><?php echo $pengguna_hapus->pengguna_nama; ?></b> akan dihapus. dan semua artikel yang ditulis oleh <b>
<?php echo $pengguna_hapus->pengguna_nama; ?></b> akan dipindahkan ke ?</p>
