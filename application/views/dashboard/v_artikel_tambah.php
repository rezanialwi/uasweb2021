...
<a href="<?php echo base_url().'dashboard/artikel'; ?>" class="btn btn-sm btn-primary">
Kembali</a>
<br/>
<br/>
...
<label>Judul</label>
<input type="text"placeholder="Masukkan judul artikel.." name="judul" class="form-control" value="<?php echo set_value('judul'); ?>"> 
<br/>
